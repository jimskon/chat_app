...
class ChatRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_room" do
    assert_difference("ChatRoom.count") do
      post chat_rooms_url, params: { chat_room: { name: @chat_room.name, topic: @chat_room.topic } }
    end
  ...
  test "should update chat_room" do
    patch chat_room_url(@chat_room), params: { chat_room: { name: @chat_room.name, topic: @chat_room.topic } }
